        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <div class="tab-content">
			...
			<td class="text-left"><?php echo $entry_description; ?></td>
				...
				<td class="text-left" style="width: 30%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]" value="<?php echo $banner_image['description']; ?>" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td>
