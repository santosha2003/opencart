...
function preloaderStart() {
    ...
    if (is_touch_device()) {} else {
        if ($('#qc_confirm_order:hover').length > 0) qc.confirmOrderVar = 1;
        else qc.confirmOrderVar = 0;
    }
...
qc.Login = qc.Model.extend({
    ...
    updateAccount: function(account) {
        ...
        var that = this;
        $.post('index.php?route=d_quickcheckout/login/updateAccount', {
...
qc.PaymentAddress = qc.Model.extend({
    ...
    changeAddress: function(address_id) {
        ...
        var json = this.toJSON();
        var that = this;
        $.post('index.php?route=d_quickcheckout/payment_address/update', {
...
qc.PaymentAddressView = qc.View.extend({
    ...
    setZone: function(country_id) {
        var that = this;
        $.post('index.php?route=d_quickcheckout/field/getZone', {
...
qc.ShippingAddress = qc.Model.extend({
    ...
    changeAddress: function(address_id) {
        ...
        var json = this.toJSON();
        var that = this;
        $.post('index.php?route=d_quickcheckout/shipping_address/update', {
        ...
        if (Number(this.model.get('payment_popup'))) {
            ...
            $.ajax({
                ...
                success: function(data){
                    $('#minicart-container').html(data.minicart);
                }
            });
...
qc.Confirm = qc.Model.extend({
    ...
    updateField: function(name, value) {
        ...
        var json = this.toJSON();
        var that = this;
        $.post('index.php?route=d_quickcheckout/confirm/updateField', {
    ...
    recreateOrder: function() {
        $.post('index.php?route=d_quickcheckout/confirm/recreateOrder', '', function(data) {}, 'json').error();
    }
});
qc.ConfirmView = qc.View.extend({
    ...
    confirm: function() {
        ...
        if ($("#d_quickcheckout #cart_view .alert-danger").length) {
            ...
            preloaderStop();
            $('html,body').animate({
                scrollTop: $("#d_quickcheckout #cart_view .alert-danger").offset().top - 60
            }, 'slow');
        }
