      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons">
          <div class="pull-right"><?php echo $text_agree; ?>
            <?php if ($agree) { ?>
            <input type="checkbox" class="checkbox" id="polit-check0" name="agree" value="1" checked="checked" />
			<label for="polit-check0"></label>
            <?php } else { ?>
            <input type="checkbox" id="polit-check1" class="checkbox" name="agree" value="1" />
			 <label for="polit-check1"></label>
            <?php } ?>
            &nbsp;
