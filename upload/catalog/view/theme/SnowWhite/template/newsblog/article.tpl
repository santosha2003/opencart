		...
		<div id="content" class="<?php echo $class; ?>">
			...
			<div class="row">
				<div class="col-sm-12 article-main clearfix">
					...
					<?php if ($thumb || $images) { ?>
						<?php if ($thumb) { ?>
						<img class="article-page-img" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
						<?php } ?>
						<?php if ($images) { ?>
						<?php foreach ($images as $image) { ?>
						 <img class="article-page-img" src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
						<?php } ?>
						<?php } ?>
					<?php } ?>
					...
					<b>
						<?php echo $attribute_item['name'];?>:</b>
					<?php echo $attribute_item['text'];?><br />
					<?php } ?>
					<?php } ?>
					<?php } ?>
				</div>
					...
					<div class="product-thumb transition">
						...
						<div class="caption">
							...
							<p class="price">
								...
								<span class="price-new">
									<?php echo $product['special']; ?></span> <span class="price-old">
						...
						<div class="button-group">
							<button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="hidden-xs hidden-sm hidden-md">
									<?php echo $button_cart; ?></span> <i class="fa fa-shopping-cart"></i></button>
