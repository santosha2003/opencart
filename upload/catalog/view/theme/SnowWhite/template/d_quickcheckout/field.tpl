	...
	<% if(model[model.config.id][f.id] !== undefined || f.type == "heading" || f.type == "label"){ %>
		<% if(f.type){ %>
	    	...
	    	<% }else if(f.type == "select"){ %>
		        ...
		        data-sort="<%= f.sort_order %>">
		        <!--<div class="<%= col_left %>">-->
		          <label class="control-label checkout-label clearfix" for="<%= model.config.id %>_<%= f.id %>"> 
			...
			<% }else if(f.type == "tel"){ %>
			      <div id="<%= model.config.id %>_<%= f.id %>_input" 
			        ...
			        data-sort="<%= f.sort_order %>">
			          ...
			          <label class="control-label checkout-label clearfix" for="<%= model.config.id %>_<%= f.id %>"> 
			            <span class="text" <%= f.tooltip ? 'data-toggle="tooltip"' : '' %> title="<%= f.tooltip %>"> <%= htmlDecode(f.title) %>
						</span> 
						<input type="<%= f.type %>" 
			            name="<%= model.config.id %>.<%= f.id %>" 
			            id="<%= model.config.id %>_<%= f.id %>" 
