...
<div class="row">
  ...
  <div id="links<?php echo $module; ?>">
    <?php if ($setting['thumb_style'] == 0) { ?>
     <div class="row" id="0links<?php echo $module; ?>" style="display: none;">
      <?php foreach ($images as $gimage) { ?>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
          ...
          <?php if ($setting['thumb_title']) { ?>
			<div style="font-size: 16px;" class="prog_title"><?php echo $gimage['title']; ?></div>
				<p style="font-size: 12px; padding-left: 10px;"><?php echo $gimage['description']; ?></p>
			<div class="prog_title">
				<?php if($gimage['link']): ?>
					<a href="<?php echo $gimage['link']; ?>">Этот товар в магазине</a>
				<?php endif; ?>
			</div>
          <?php } ?>
          </div>
