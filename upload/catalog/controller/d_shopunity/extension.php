...
class ControllerDShopunityExtension extends Controller {
	...
	public function uninstall(){
		...
		// 	if($this->validateSecret($this->request->get['secret'])){
		// 		$this->load->model('extension/module/d_mbooth');

		// 		$json = $this->model_extension_module_d_mbooth->deleteExtension($this->request->get['codename']);
		...
		if(isset($this->request->get['extension_id']) && isset($this->request->get['secret']) && isset($this->request->get['access_token'])){
			...
			if($this->validateSecret($this->request->get['secret'])){
				...
				try{
					...
					$this->model_d_shopunity_account->setAccessToken($this->request->get['access_token']);
