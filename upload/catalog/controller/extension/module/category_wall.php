...
//        $categories = $this->model_catalog_category->getCategories(0);  //root
        $categories = $this->model_catalog_category->getCategories(59);  //show me the magic.. 59 75 0
