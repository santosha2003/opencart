...
class ControllerProductSpecial extends Controller {
	public function index() {
		...
		$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/special',  '&sort=pd.name&order=DESC' . $url)
			);
			...
			$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/special',  '&sort=p.price&order=DESC' . $url)
			);
			...
			$data['sorts'][] = array(
				...
				'label' => 'p.sku',
				'value' => 'p.sku-ASC',
				'href'  => $this->url->link('product/special',  '&sort=p.sku&order=ASC' . $url),
				'href2'  => $this->url->link('product/special',  '&sort=p.sku&order=DESC' . $url)
			);
			...
			$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/special', '&sort=p.date_added&order=DESC' . $url)
			);
