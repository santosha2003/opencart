	...
	public function index() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/search', '&sort=pd.name&order=DESC' . $url)
			);
			...
			$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/search', '&sort=p.price&order=DESC' . $url)
			);
			...
			$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/search', '&sort=p.model&order=DESC' . $url)
			);
			...
			$data['sorts'][] = array(
				...
				'href2'  => $this->url->link('product/search', '&sort=p.date_added&order=DESC' . $url)
			);
