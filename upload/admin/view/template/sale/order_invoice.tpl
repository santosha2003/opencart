      ...
      <tbody>
        <tr>
          <td style="width: 50%;"><address>
            ...
            <b>la<?php echo $text_telephone; ?></b> <?php echo $order['store_telephone']; ?><br />
            <?php if ($order['store_fax']) { ?>
            <b><?php echo $text_fax; ?></b> <?php echo $order['store_fax']; ?><br />
            <?php } ?>
            <b><?php echo $text_email; ?></b> <?php echo $order['store_email']; ?><br />
            <b><?php echo $text_website; ?></b> <a href="<?php echo $order['store_url']; ?>"><?php echo $order['store_url']; ?></a></td>
          <td style="width: 50%;"><b><?php echo $text_date_added; ?></b> <?php echo $order['date_added']; ?><br /><br>
            <b>Информация о покпателе</b><br>
            <b><?php echo 'Телефон: '; ?></b> <?php echo $order['telephone']; ?><br />
            <b><?php echo 'Email: '; ?></b> <?php echo $order['email']; ?><br />
            <b><?php echo 'Комментарий: '; ?></b> <?php echo $order['comment']; ?><br />
