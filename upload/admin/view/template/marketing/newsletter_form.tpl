            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab-general">
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-news_email"><?php echo $entry_news_email; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="news_email" value="<?php echo $news_email; ?>" placeholder="<?php echo $entry_news_email; ?>" id="input-news_email" class="form-control" />
                    <?php if ($error_news_email) { ?>
                    <div class="text-danger"><?php echo $error_news_email; ?></div>
                    <?php } ?>
                  </div>
