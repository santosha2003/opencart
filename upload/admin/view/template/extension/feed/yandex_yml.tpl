    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="tab-pane active" id="tab-general">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label" for="input-shop-sku-field">Брать тэг shop-sku из поля</label>
				<div class="col-sm-9">
					<select name="yandex_yml_shop_sku_field" id="input-shop-sku-field" class="form-control">
					<option value=""><?php echo $entry_dont_export; ?></option>
					<?php foreach ($oc_fields as $key=>$name) { ?>
					<option value="<?php echo $key; ?>"<?php echo ($key==$yandex_yml_shop_sku_field ? ' selected="selected"' : ''); ?>>
					<?php echo $name; ?>
					</option>
					<?php } ?>
					</select>
                    <span style="color: red;">Для Яндекс.Маркет не выгружать (для beru.ru)</span> <a href="https://yandex.ru/support/marketplace/catalog/yml-elements.html" target="_blank">подробнее</a>
				</div>
			</div>
		...
		<div class="tab-pane" id="tab-categories">
	        ...
	        <div class="tab-pane" id="tab-promo">
				...
				<?php /*
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="input-flash_discount"><span data-toggle="tooltip" title="Период акции не более 7 дней">Спеццена ограниченное время</span></label>
                    <div class="col-sm-9">
                    <div class="checkbox">
                    <label><input type="checkbox" name="yandex_yml_flash_discount" id="input-flash_discount" value="1"<?php echo ($yandex_yml_flash_discount ? ' checked="checked"' : ''); ?>></label>
                ...
                */ ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
                        ...
                        ?>
                            <div class="checkbox"><?php if (in_array($coupon['coupon_id'], $yandex_yml_coupons)) { ?>
                            <label><input type="checkbox" name="yandex_yml_coupons[]" value="<?php echo $coupon['coupon_id']; ?>" checked="checked" /></label>
                            <?php echo $coupon['name']; ?>
                            <?php } else { ?>
                            <label><input type="checkbox" name="yandex_yml_coupons[]" value="<?php echo $coupon['coupon_id']; ?>" /></label>
                            <?php echo $coupon['name']; ?>
                            <?php } ?>
                            </div>
                        <?php } ?>
					...
					<div class="col-sm-9" id="promo-gifts">
						...
						<div class="gift-block">
						  <table class="gift-ctrl" width="100%">
							<tbody><tr>
								<td width="25%" style="padding: 0 5px 0 0;">Название&nbsp;акции: <input type="text" name="yandex_yml_gift_promo_name[]" value="<?php echo $yandex_yml_gift_promo_name[$gift_id]; ?>" size="40" class="form-control input-sm" /></td>
								<td width="20%" style="padding: 0 5px 0 0;">Подарок: <input type="text" name="yandex_yml_gift_promo_gift[]" value="<?php echo $yandex_yml_gift_promo_gift[$gift_id]; ?>" size="30" class="form-control input-sm" /></td>
								<td style="padding: 0 5px 0 0;"><img class="gift-image" src="<?php echo ($yandex_yml_gift_promo_img[$gift_id] ? $yandex_yml_gift_promo_img[$gift_id] : HTTPS_IMAGE.'no_image.jpg'); ?>" width="40" height="40" /></td>
								<td width="25%" style="padding: 0 5px 0 0;">Фото&nbsp;подарка: <input type="text" class="form-control gift-image-url input-sm" name="yandex_yml_gift_promo_img[]" value="<?php echo $yandex_yml_gift_promo_img[$gift_id]; ?>" placeholder="<?php echo HTTPS_CATALOG; ?>..." size="40" /></td>
							...
							<td width="15%" style="padding: 0 5px 0 0;">сохранено&nbsp;значение: <input type="text" name="yandex_yml_gift_promo_val[]" value="<?php echo $yandex_yml_gift_promo_val[$gift_id]; ?>" size="20" class="form-control input-sm" /></td>
...
<div id="gift-seed" style="display:none;" class="gift-block">
  <table class="gift-ctrl" width="100%">
    <tbody><tr>
        <td width="25%" style="padding: 0 5px 0 0;">Название&nbsp;акции: <input type="text" name="yandex_yml_gift_promo_name[]" value="" size="40" class="form-control input-sm" /></td>
        <td width="20%" style="padding: 0 5px 0 0;">Подарок: <input type="text" name="yandex_yml_gift_promo_gift[]" value="" size="30" class="form-control input-sm" /></td>
        <td style="padding: 0 5px 0 0;"><img class="gift-image" src="<?php echo HTTPS_IMAGE.'no_image.jpg'; ?>" width="40" height="40" /></td>
        <td width="25%" style="padding: 0 5px 0 0;">Фото&nbsp;подарка: <input type="text" class="gift-image-url form-control input-sm" name="yandex_yml_gift_promo_img[]" value="" placeholder="<?php echo HTTPS_CATALOG; ?>..." size="40" /></td>
        <td width="15%" style="padding: 0 5px 0 0;">Товары,&nbsp;у&nbsp;которых&nbsp;в&nbsp;поле: 
    <select name="yandex_yml_gift_promo_field[]" class="form-control input-sm">
    ...
    <td width="15%" style="padding: 0 5px 0 0;">сохранено&nbsp;значение: <input type="text" name="yandex_yml_gift_promo_val[]" value="" size="20" class="form-control input-sm" /></td>
    <td><i class="fa fa-minus-circle delete-gift"></i></td>
    </tr></tbody>
  </table>
</div>
