...
class ControllerExtensionFeedYandexYml extends Controller {
	...
	protected function setFormData() {
		...
		if (isset($this->request->post['yandex_yml_sales_notesattr'])) {
			$this->tdata['yandex_yml_sales_notesattr'] = $this->request->post['yandex_yml_sales_notesattr'];
		} else {
			$this->tdata['yandex_yml_sales_notesattr'] = $this->config->get($this->CONFIG_PREFIX.'sales_notesattr');
		}
		...
		if (isset($this->request->post['yandex_yml_shop_sku_field'])) {
			$this->tdata['yandex_yml_shop_sku_field'] = $this->request->post['yandex_yml_shop_sku_field'];
		} else {
			$this->tdata['yandex_yml_shop_sku_field'] = $this->config->get($this->CONFIG_PREFIX.'shop_sku_field');
		}
        
		if (isset($this->request->post['yandex_yml_market_sku_field'])) {
			$this->tdata['yandex_yml_market_sku_field'] = $this->request->post['yandex_yml_market_sku_field'];
		} else {
			$this->tdata['yandex_yml_market_sku_field'] = $this->config->get($this->CONFIG_PREFIX.'market_sku_field');
		}
		...
		if (isset($this->request->post['yandex_yml_quantity_in_stock'])) {
			$this->tdata['yandex_yml_quantity_in_stock'] = $this->request->post['yandex_yml_quantity_in_stock'];
		} else {
			$this->tdata['yandex_yml_quantity_in_stock'] = $this->config->get($this->CONFIG_PREFIX.'quantity_in_stock');
		}
		if (isset($this->request->post['yandex_yml_min_quantity'])) {
			$this->tdata['yandex_yml_min_quantity'] = $this->request->post['yandex_yml_min_quantity'];
		} else {
			$this->tdata['yandex_yml_min_quantity'] = $this->config->get($this->CONFIG_PREFIX.'min_quantity');
		}
		if (isset($this->request->post['yandex_yml_order_quantity'])) {
			$this->tdata['yandex_yml_order_quantity'] = $this->request->post['yandex_yml_order_quantity'];
		} else {
			$this->tdata['yandex_yml_order_quantity'] = $this->config->get($this->CONFIG_PREFIX.'order_quantity');
		}
		...
		if (isset($this->request->post['yandex_yml_image_mandatory'])) {
			$this->tdata['yandex_yml_image_mandatory'] = $this->request->post['yandex_yml_image_mandatory'];
		} else {
			$this->tdata['yandex_yml_image_mandatory'] = $this->config->get($this->CONFIG_PREFIX.'image_mandatory');
		}
        
		if (isset($this->request->post['yandex_yml_exportattr'])) {
			$this->tdata['yandex_yml_exportattr'] = $this->request->post['yandex_yml_exportattr'];
		} else {
			$this->tdata['yandex_yml_exportattr'] = $this->config->get($this->CONFIG_PREFIX.'exportattr');
		}
		...
		if (isset($this->request->post['yandex_yml_price_old'])) {
			$this->tdata['yandex_yml_price_old'] = $this->request->post['yandex_yml_price_old'];
		} else {
			$this->tdata['yandex_yml_price_old'] = $this->config->get($this->CONFIG_PREFIX.'price_old');
		}
		...
		if (isset($this->request->post['yandex_yml_purchase_price'])) {
			$this->tdata['yandex_yml_purchase_price'] = $this->request->post['yandex_yml_purchase_price'];
		} else {
			$this->tdata['yandex_yml_purchase_price'] = $this->config->get($this->CONFIG_PREFIX.'purchase_price');
		}
		...
		if (isset($this->request->post['yandex_yml_option_image_pro'])) {
			$this->tdata['yandex_yml_option_image_pro'] = $this->request->post['yandex_yml_option_image_pro'];
		} else {
			$this->tdata['yandex_yml_option_image_pro'] = $this->config->get($this->CONFIG_PREFIX.'option_image_pro');
		}
